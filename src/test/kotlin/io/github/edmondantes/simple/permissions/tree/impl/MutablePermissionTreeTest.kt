...
class MutablePermissionTreeTest {
    ...
    fun testAddSimplePermissionToEmptyTree() {
        ...
        val tree = MutablePermissionTree(mapper, permissionNodeStorage, rootNode)

        val permission = "a.b.c"
        tree.addPermission(permission)

        assertTrue(tree.checkPermission(permission))
    ...
    fun testAddPermissionWithAllAndGetConflictInTree() {
        ...
        val permission = "a.b.*"
        tree.addPermission(permission)
        assertTrue(tree.checkPermission("a.c"))
        assertTrue(tree.checkPermission("a.b.c"))
        assertTrue(tree.checkPermission("a.b.d"))
        assertTrue(tree.checkPermission("a.b.d.e"))
        assertTrue(tree.checkPermission(permission))
    ...
    fun testAddSimplePermissionToTreeWithIgnoreAll() {
        ...
        val permission = "a.b.d.e"
        tree.addPermission(permission)
        assertTrue(tree.checkPermission("a.c"))
        assertFalse(tree.checkPermission("a.b.d.t"))
        assertTrue(tree.checkPermission(permission))
    ...
    fun testWrongPermissions() {
        val tree = MutablePermissionTree(mapper, permissionNodeStorage, entityNode(permissionNodeStorage) {})
    ...
    private fun BaseStorage<Int, PermissionNode>.checkTreeFromStore(rootId: Int, func: CheckNodeChildren.() -> Unit) {
        ...
        Assertions.assertNull(rootNode!!.value)
